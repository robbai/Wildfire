...
public class Test {
	...
	public static void main(String[] args){
		...
		for(int i = 0; i < 10; i++){
			...
			double forwardVelocity = ((r.nextDouble() - 0.5) * 2 * Constants.MAX_CAR_VELOCITY);
...
//			double forwardVelocity = 2281;
			...
			System.out.println("So if I'm travelling at " + Utils.round(forwardVelocity)
					...
					+ ", you're telling me I gotta input an angle of "
					+ Utils.round(Math.toDegrees(table.getInputForAngle(desiredAngle, forwardVelocity))) + "?!");
		}
	}
